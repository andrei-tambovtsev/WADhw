<template>
  <div class="about">
    ...
    <h2>About the homework</h2>
    <div>
      <p>It was the hardest homework so far.
      We went from excitement to devastation in seconds. <br>
      ...
      <p> But overall we are looking forward to the next homework.</p>
